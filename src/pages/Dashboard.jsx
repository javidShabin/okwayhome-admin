    ...
    <div>
      ...
      <main className="flex-1 p-6">
        ...
        <div className="bg-white shadow-xl rounded-lg p-6 mt-8">
          <h2 className="text-gray-800 text-xl font-bold mb-6">Recent Orders</h2>
          <table className="min-w-full table-auto">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-4 py-2 text-left text-gray-600 font-semibold">Order ID</th>
                <th className="px-4 py-2 text-left text-gray-600 font-semibold">Customer</th>
            ...
            <tbody className="bg-white">
              <tr className="border-b">
                ...
                <td className="px-4 py-3">
                  <span className="text-sm text-green-700 bg-green-200 px-3 py-1 rounded-full">Delivered</span>
                </td>
              </tr>
              <tr className="border-b">
                ...
                <td className="px-4 py-3">
                  <span className="text-sm text-yellow-700 bg-yellow-200 px-3 py-1 rounded-full">Pending</span>
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">
                  <span className="text-sm text-red-700 bg-red-200 px-3 py-1 rounded-full">Cancelled</span>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="bg-white shadow-xl rounded-lg p-6 mt-8">
          ...
          <table className="min-w-full table-auto">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-4 py-2 text-left text-gray-600 font-semibold">User</th>
                <th className="px-4 py-2 text-left text-gray-600 font-semibold">Rating</th>
                <th className="px-4 py-2 text-left text-gray-600 font-semibold">Comment</th>
                <th className="px-4 py-2 text-left text-gray-600 font-semibold">Action</th>
              </tr>
            </thead>
            <tbody className="bg-white">
